...
# locations.
CONFIG_DIR = '/usr/local/share/zenmap/config'
LOCALE_DIR = '/usr/local/share/zenmap/locale'
MISC_DIR = '/usr/local/share/zenmap/misc'
PIXMAPS_DIR = '/usr/local/share/zenmap/pixmaps'
DOCS_DIR = '/usr/local/share/zenmap/docs'
