...
(defvar custom-versions-load-alist '(("20.3.3" "dos-vars") ("19.29" time-stamp) ("20.1" time-stamp) ("22.3" message) ("20.4" crisp compile hilit-chg sh-script) ("21.3" gnus-agent sql ange-ftp) ("20.8" sql) ("21.2" mm-util) ("22.2" vc-mtn tls mail-source find-dired vc-hg bibtex-style gnus-sum dired css-mode desktop sql gdb-mi) ("23.2" mm-encode rmail gnus-group gnus-sum help-fns diary-lib dired calendar tramp-gvfs elint auth-source bytecomp ansi-color doc-view lunar desktop comint message rmailmm gdb-mi) ("20.3" paren avoid xscheme msb sendmail etags find-func dabbrev compile which-func hexl uce vc add-log ffap rmail vcursor browse-url diary-lib cus-edit debug) ("23.3" diary-lib python desktop rmailsum rmail calendar) ("21.1" paren sb-image strokes dabbrev debug net-utils rmail latin1-disp sgml-mode wid-edit server gnus-start find-func message ange-ftp hideshow ezimage vc-cvs rmailedit vc cal-hebrew browse-url vc-rcs etags flyspell cus-edit gnus-group fortran add-log sendmail smtpmail ps-print vc-sccs gnus-agent nnmail gnus-sum gnus-art cperl-mode) ("24.1" esh-arg em-hist url-cache ange-ftp em-prompt mm-decode comint pcmpl-unix em-banner hl-line appt gnus-srvr ibuffer em-term pop3 em-script auth-source em-cmpl em-alias dired-x etags em-glob em-rebind em-dirs vc mm-view esh-util em-smart em-pred cus-edit vc-git smtpmail vc-sccs smiley gnus-msg shr gnus-art esh-proc gnus-start emacs-lock shell cc-fonts vc-hg gnus-html image-mode esh-var rmail vc-cvs woman em-ls esh-cmd calendar gnus-group find-dired server saveplace ido f90 copyright diary-lib url-queue vc-rcs gnus-gravatar python gnus-sum glasses package-x browse-url package flyspell info rst mml esh-mode mml2015 message feedmail sendmail esh-io sql rcirc vc-svn log-edit gnus-util em-unix esh-ext js compile gnus) ("22" ps-print ebnf2ps) ("22.1" add-log generic-x bookmark gnus-util gnus-score allout dabbrev sgml-mode fortran sql uudecode ispell landmark gnus-int find-func hi-lock gnus-srvr cal-dst binhex gnus-win sh-script comint mail-extr shadowfile descr-text smime time latin1-disp vc flow-fill calendar hl-line tex-mode glasses info view nnmail ielm mml mm-util mml2015 locate cal-tex spam mm-url sendmail keypad iswitchb mm-view imap warnings vc-svn diary-lib starttls ffap ange-ftp gnus tls gnus-cite vc-cvs gnus-group gnus-delay make-mode compare-w tcl mm-uu imenu gnus-agent gnus-art diff-mode rmail desktop compile gnus-sum mml-sec gnus-fun grep dired deuglify autorevert gnus-start gdb-mi message gnus-msg cus-edit pop3 server mail-source mm-decode gnus-spec) ("20" ps-print ebnf2ps) ("23.1" view nnmail checkdoc vc-git cus-edit newcomment compile net-utils smiley hideif vc-arch fortune f90 "misearch" mml descr-text info face-remap dired-aux gnus-draft bibtex gnus gnus-util smime ffap pop3 tls spam-report gnus-dired mm-decode copyright allout mm-uu gnus-sum vc-hg calendar holidays gdb-mi gnus-score informat fortran rmail rmailmm gnus-group server vc-mtn filesets message gnus-msg pcmpl-unix vc-cvs sendmail woman gnus-bookmark browse-url time imap tex-mode gnus-art icomplete nnmairix))
